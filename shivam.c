...
printf(" 10% discount is applicable on the customers who enroll both shifts");
...
// Member 1
printf(" Rs 500/- off to all new customer");

for(i=1;i<=2;i++)

{

	if(  strcasecmp(ob[i].customer_history,"New")==0 )
